<div id="videos-list">
                ...
                <div class="video-item col-md-10 pull-left panel panel-default">
                    <div class="panel-body">
                        ...
                        <!--BOTONES-->
                        <a href="{{route('detailVideo', ['video_id'=>$video->id])}}" class="btn btn-success">Ver Vídeo</a>
                        @if(Auth::check() && Auth::user()->id == $video->user->id)
                        <a href="{{route('videoEdit', ['video_id'=>$video->id])}}" class="btn btn-primary">Editar</a>
                ...
                <div class="alert alert-warning">No hay videos coincidentes</div>
